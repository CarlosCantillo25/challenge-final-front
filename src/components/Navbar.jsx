  ...
  return (
    <nav className="bg-[#007BFF] w-full h-[25vh]">
      <div className="h-[15vh] w-full bg-[#007BFF] flex justify-around items-center px-6">
        <img src="/logo2.png" alt="logo" className="w-[6rem] object-contain" />
        <div className="relative flex items-center">
          <input type="text" placeholder="Find what you are looking for" className="w-[20rem] lg:w-[30rem] h-[2.5rem] rounded-[5px] pl-[1rem] pr-[3rem] bg-white border-[#007BFF] focus:ring-[#007BFF] focus:shadow-[#007BFF] outline-none"/>
        ...
        <div className='flex flex-col items-center'>
          ...
          <div className='hidden lg:flex w-[8rem] justify-around'>
        ...
        <p className='hidden lg:text-[white]'>My shopping cart</p>
      </div>
      ...
      <div id='segunda seccion' className="bg-[#F5F5F5] h-[10vh] w-full flex items-center p-10">
        <div className="relative group bg-[#FFFBEB] h-[10vh] pt-[1.5rem] pl-[1.8rem] w-[30rem]" onMouseEnter={openDropdown} onMouseLeave={closeDropdown}>
          <span className="text-[gray] cursor-pointer font-semibold lg:text-2xl text-xl hover:">CATEGORIES</span>
          {isDropdownOpen && (
